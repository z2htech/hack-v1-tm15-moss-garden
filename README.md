# Moss_bot - 顶级交易员的推文监控系统

## 项目介绍

Moss Garden 是一个专为加密货币交易爱好者开发的黑客松项目，旨在实时监控顶级交易员的Twitter动态并进行情绪分析，帮助用户快速获取市场情绪和趋势信息。系统通过自动爬取、分析交易员推文，并将有价值的市场洞察通过Telegram机器人推送给用户。
...
1. 克隆仓库
   ```
   git clone https://github.com/yourusername/moss-garden.git
   cd moss-garden
   ```
...
本项目不同于一般的Twitter爬虫，它特别关注加密货币交易领域的顶级交易员，并且直接从网页中提取预先分析好的情绪数据，包括情绪标签、原因和详细解释，为用户提供更准确的市场洞察。
